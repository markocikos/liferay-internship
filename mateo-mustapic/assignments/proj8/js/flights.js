...
$(document).ready(function(){
	...
	function addJFK () { 
		...
		var node = document.createTextNode(`John F. Kennedy International Airport (IATA: JFK, ICAO: KJFK, FAA LID: JFK) 
	...
	function addDubai () { 
		var para = document.createElement("p");
		var node = document.createTextNode(`Dubai International Airport (IATA: DXB, ICAO: OMDB) is the primary airport serving Dubai, 
	...
	function addFrankfurt () { 
		var para = document.createElement("p");
		var node = document.createTextNode(`Frankfurt Airport (IATA: FRA, ICAO: EDDF) is a major international airport located in Frankfurt.  
