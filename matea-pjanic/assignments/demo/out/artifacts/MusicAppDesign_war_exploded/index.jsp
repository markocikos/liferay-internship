...
<html>
  ...
  <jsp:include page="header.jsp" >
    ...
    <jsp:param name="login" value="<a href='login.jsp'>Login</a>" />
    <jsp:param name="join" value="<a href='join.jsp'>Join</a>" />
    <jsp:param name="artists" value="<a href='#artists'>Top artists</a>" />
    <jsp:param name="tracks" value="<a href='#tracks'>Top tracks</a>" />
    <jsp:param name="events" value="<a href='#events'>Events</a>" />
